A huge bug in CNContactViewController, when you use `CNContactViewController(forUnknownContact:)`.  It destroys the surrounding interface so that your app becomes useless; the user is ultimately stuck.
